                ...
                <tbody>
                    @forelse($finisheds as $finished)
                        <tr>
                            ...
                            <td>
                                {{ number_format(($finished->total_raw_materials_cost/$finished->kilos_per_dough),3)  }}
                            </td>
                            <td>
                                {{ number_format(($finished->labor_costs/$finished->kilos_per_dough),3)  }}
                            </td>
                            <td>
                                {{ number_format(($finished->semi_finished_quantity_total/$finished->kilos_per_dough),3)  }}
                            </td>
                            <td>
                                {{ number_format($finished->cost_per_unit,3) }}
                            </td>
                            <td>
                                {{ $finished->sale_price }}
                            </td>
